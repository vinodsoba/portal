...
if($_POST['submit']){	
	if(isset($_POST['sku'])){
		...
		while($row=$result->fetch(PDO::FETCH_ASSOC)){
			...
			echo "<form action='process_upload.php' id='myForm' name='myForm' method='POST'><tr><td><label>Product Code:</label></td><td><input type='text' id='sku' name='sku' value='" .$sku ."'></td>";
			...
			$profit = $feessftershipping - $hpprice;
