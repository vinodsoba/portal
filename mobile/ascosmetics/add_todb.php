...
) VALUES ( '$store', '$websites', '$attset', '$type', '$category', '$sku', '$hasoptions', '$name', '$metatitle', '$metadesc', '$image', '$smallimage', '$thumbnail', '$urlkey ', '$urlpath ', '$customdesign ', '$pagelayout ', '$optionscontainer', '$imagelabel ', '$smallimagelabel ', '$thumbnaillabel ', '$countryofmanufacture',  '$msrpenabled', '$msrpdisplayactualpricetype', '$giftmessageavailable', '$giftwrappingavailable', '$price', '$specialprice', '$weight', '$msrp', '$giftwrappingprice', '$status', '$isrecurring', '$visibility', '$taxclassid', '$maxfactorcolourshades', '$description', '$shortdescription', '$metakeyword',  '$customlayoutupdate', '$specialfromdate', '$specialtodate', '$newsfromdate',  '$newstodate', '$customdesignfrom', '$customdesignto', '$qty', '$minqty', '$useconfigminqty', '$isqtydecimal', '$backorders', '$useconfigbackorders', '$minsaleqty', '$useconfigminsaleqty',  '$maxsaleqty', '$useconfigmaxsaleqty',  '$isinstock',  '$lowstockdate', '$notifystockqty', '$useconfignotifystockqty', '$managestock', '$useconfigmanagestock', '$stockstatuschangedauto', '$useconfigqtyincrements', '$qtyincrements', '$useconfigenableqtyinc', '$enableqtyincrements', '$isdecimaldivided', '$stockstatuschangedautomatically', '$useconfigenableqtyincrements', '$productname',  '$storeid', '$producttypeid', '$productstatuschanged', '$productchangedwebsites', '$productbrand', '$format', '$booksmusictype', '$bottlesize', '$authorartist', '$genre' )");
