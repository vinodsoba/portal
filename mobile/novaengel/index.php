...
<div data-role="page" data-theme="b">
		<div data-role="content">
			<h2>Welcome to your Nova Engel DASHBOARD</h2>
		<button class="workout-pricing" type="button" >Workout Pricing</button>
		<button class="load-products" type="button" >Nova Engel</button>
		...
		<button type="button" class="profit-sheet" onclick="loadProfitSheet()">Calculate Profit</button>
