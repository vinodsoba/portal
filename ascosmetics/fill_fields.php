...
if(isset($_POST['sku']) || empty($_POST['sku'])){
     ...
     //run query to db
     $sql11 ="SELECT prod_code, prod_description, manu_name, brand_name, prod_name FROM product WHERE prod_code = '$sku'";
    ...
    echo '<form id="form_upload" name="form_upload">
          ...
          <input type="text" name="product_brand" value="'. $manuname .'"><br>
