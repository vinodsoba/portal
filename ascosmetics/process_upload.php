...
if ($row > 0){
	...
	$sql1=("INSERT into product_calc (id, sku, prod_name, buying_price, qty, price_per_unit, our_price, ebay_result, after_ebay_fees, paypal, after_fees, shipping, profit_per_item, profit_bulk, creation_date) VALUES ('$id', '$sku', '$prodname',  '$amprice1', '$qty', '$priceperunit', '$ourprice', '$ebayresult',  '$afterebayfees', '$paypal', '$afterfees', '$shipping', '$profit', '$profitbulk', '$createdate')");
